...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@pyroswap/sdk'
...
describe('utils', () => {
  describe('#getBscScanLink', () => {
    ...
    it('ropsten', () => {
      expect(getBscScanLink(3, 'abc', 'address')).toEqual('https://etherscan.io/address/abc')
    })
    it('enum', () => {
      expect(getBscScanLink(ChainId.MAINNET, 'abc', 'address')).toEqual('https://etherscan.io/address/abc')
    })
  })
