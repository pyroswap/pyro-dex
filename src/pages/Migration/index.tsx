...
import { Heading, Card, CardHeader, CardBody, Text, Button, Link, Flex, ArrowDownIcon } from '@pyroswap/uikit'
        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://dex.pyroswap.com/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://pyroswap.com/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>
